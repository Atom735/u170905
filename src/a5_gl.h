...
} A5V_2DTXT, *pA5V_2DTXT;

typedef struct tagA5GLV_2DTXT {
    GLuint  p, v, f;
    GLint   _aPos, _aTex, _aCol,
            _uPos, _uMat, _uTex, _uTsz;
} A5GLV_2DTXT, *pA5GLV_2DTXT;
...
typedef struct tagA5S_TXT_Settings {
    pA5FT_Glyph    *pzTxtGlyphs;
    GLuint         *pzTxtUint;
    GLchar         *pzTxtChar;
    pA5FT_Cache     pCache;
    FTuint          uFontID;
...
} A5S_TXT_Settings, *pA5S_TXT_Settings;
